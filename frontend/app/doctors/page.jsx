      ...
      <div className="w-full min-w-0">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-teal-700 hover:bg-teal-800 text-white text-sm font-medium rounded-lg px-4 py-2.5 transition-colors shrink-0"
          >
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-4 mb-5">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <input
              ...
              className="px-3 py-2 text-sm rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-teal-600 w-full sm:w-40"
            />
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <input
                ...
                className="px-3 py-2 text-sm rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-teal-600 w-full sm:w-auto min-w-0"
              />
            ...
            {hasActiveFilters && (
              <button
                ...
                className="flex items-center gap-1.5 text-sm font-medium text-slate-500 hover:text-slate-700 px-2 py-2 shrink-0"
              >
                <X className="w-4 h-4" />
                Clear
              </button>
                    ...
                    >
                      ...
                      <td className="px-5 py-3 text-right">
                        <Link
                          ...
                          className="inline-flex items-center gap-1 text-teal-700 hover:text-teal-800 font-medium whitespace-nowrap"
                        >
                          Patients
